...
type (
	// LocalParty represents a local participant in the EdDSA key generation protocol.
	LocalParty struct {
		*tss.BaseParty
...
// Deprecated: Use eddsatss.NewKeygen instead, which provides a simpler broker-based API
...
// FirstRound returns the first round of the EdDSA keygen protocol.
